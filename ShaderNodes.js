...
CRAYON.ShaderNode = Class.extend( {
...
CRAYON.PostProcessNode = CRAYON.ShaderNode.extend( {
...
CRAYON.ExecutorNode = CRAYON.ShaderNode.extend( {
...
CRAYON.RenderToScreenNode = CRAYON.PostProcessNode.extend( {
	...
	init: function ( renderer ) {
		...
		this._super( renderer, shaderMaterial );
